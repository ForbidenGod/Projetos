...
# implementação da função de colisão para saber quando existe o contato do jogador com obtaculos
# como estes calculos são feitos de poligono com poligono, são mais complexos.
# em resumo ele faz o calculo da projeção de linha que o objeto segue, com ou sem pulo
# em seguida, ele compara as linha e gravas os pontos em que essas linhas entao proximos.
# ao final ele inclui o poligono e faz a comparação  entre os pontos e linhas proximos, se vai colidir ou não.
